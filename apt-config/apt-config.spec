...
%{__cat} <<EOF >magic.list
# Name: aptrpms
# URL: http://auvtech.com/~xinzhen/downloads/apt/

### MagicLinux %{magic_ver}
rpm http://apt.magiclinux.org:81/magic/%{magic_ver} unstable all extras nosrc
rpm-src http://apt.magiclinux.org:81/magic/%magic_ver} unstable all extras

rpm http://www.321211.net/apt/magic/%{magic_ver} unstable all extras nosrc
rpm-src http://www.321211.net/apt/magic/%{magic_ver} unstable all extras
...
%{__install} -p -m0644 magic.list %{buildroot}%{_sysconfdir}/apt/sources.list.d/
